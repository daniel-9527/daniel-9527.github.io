...
Carousel.prototype = {
    ...
    changeZindex_add:function(){
        ...
        var lastImg = $(".transverse-box").find(".img-item").eq(length).find("img");
        var lastImgSrc = lastImg.attr("src");
        var lastImgAlt = lastImg.attr("alt");
        var lastImgUrl = lastImg.attr("url");
        var f1Img = $(".transverse-box").find(".img-item").eq(length-3).find("img");
        var firstImgSrc = f1Img.attr("src");
        var firstImgUrl = f1Img.attr("url");
        var f2Img = $(".transverse-box").find(".img-item").eq(length-2).find("img");
    ...
    changeZindex_sub:function(){
        ...
        var l1Img = $(".transverse-box").find(".img-item").eq(length-2).find("img");
        var lastImgSrc =  l1Img.attr("src");
        var lastImgUrl = l1Img.attr("url");
        var l2Img = $(".transverse-box").find(".img-item").eq(length-3).find("img");
